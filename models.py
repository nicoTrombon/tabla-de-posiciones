...
class ResultadoView(ModelView):
    ...
    column_list = ('campeonato', 'division', 'fecha', 'equipo1', 'goles1', 'equipo2',  'goles2')
    column_sortable_list = ('campeonato', 'division', 'fecha', 'equipo1', 'equipo2', 'goles1', 'goles2')
    column_searchable_list = ['campeonato', 'division', 'fecha', 'equipo1', 'equipo2']
